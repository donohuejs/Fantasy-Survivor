...
import { recordScoring,recordStillOnIsland,recordCastawayBonus,recordFirstTribalCouncil,saveCustomAction,saveMergeEpisode,saveTribe,assignCastaway,type ScoringInput,type EpisodeWideAwardInput,type CastawayBonusInput,type FirstTribalCouncilInput,type CustomActionInput } from '@/lib/scoring';
...
export function GameProvider({children}:{children:React.ReactNode}) {
  ...
  const standings = useMemo(() => activePlayers(game.players).map((player) => {
